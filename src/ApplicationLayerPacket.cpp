...
void ApplicationLayerPacket::print() {
    ...
    cout<<"Sender ID: "<<sender_ID<<", Receiver ID: "<<receiver_ID<<endl<<"Message chunk carried: \""<<message_data<<"\""<<endl;
...
string ApplicationLayerPacket::get_sender_ID() const {
    return sender_ID;
}
string ApplicationLayerPacket::get_receiver_ID() const {
    return receiver_ID;
}
string ApplicationLayerPacket::get_message_data() const {
    return message_data;
}