...
public:
    ...
    string getClientMac() const;
    unordered_map <string, string> getRoutingTable() const;
    queue<stack<Packet*>> get_incoming_queue() const;
    queue<stack<Packet*>> get_outgoing_queue() const;
