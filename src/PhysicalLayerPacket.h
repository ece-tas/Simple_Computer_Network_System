...
public:
    ...
    string get_sender_MAC_address() const;
    string get_receiver_MAC_address() const;
    void set_receiver_MAC_address(string& newMac);
    void set_sender_MAC_address(string& newMac);
};
